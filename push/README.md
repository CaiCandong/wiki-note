...
> 本目录收录移动端 Push 从基础概念到规模化治理的实战笔记。全球时区与 Campaign 规则见根目录 [push-global-timezone-delivery.md](../push-global-timezone-delivery.md)。同步约定见 [CLAUDE.md](../CLAUDE.md)。
...
| 改本地 → 同步 | 在仓库根目录：` docs +update --api-version v2 --doc "<wiki-url>" --command overwrite --doc-format markdown --content "@push/<file>.md"` |
